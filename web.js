...
app.get("/onequestion", function(req, res){
	...
	var intaliohttp = require('http');
	var parameter = '&parameter=satisfy:' + satisfy + ',price:' + price + ',reason:' + reason + ',age:' + age + ',sex:' + sex + ',';
	var url = '/cloudprotest/?accesskey=QuestionnaireProduct&intaliouser=admin' + parameter;
	var options = {
		host: 'convertintaliocloud.appspot.com',
		path: url,
		method: 'GET'
	};
	var intalioreq = intaliohttp.request(options, function(intaliores) {
		intaliores.setEncoding('utf8');
		intaliores.on('data', function (chunk) {
			try {
				var resData = eval("("+ chunk +")");
...
app.get("/twoquestion", function(req, res){
	...
	var url = '/cloudprotest/?accesskey=QuestionnaireService&intaliouser=admin' + parameter;
	var options = {
		host: 'convertintaliocloud.appspot.com',
		path: url,
		method: 'GET'
...
app.get("/threequestion", function(req, res){
	...
	var url = '/cloudprotest/?accesskey=QuestionnaireSupport&intaliouser=admin' + parameter;
	var options = {
		host: 'convertintaliocloud.appspot.com',
		path: url,
		method: 'GET'
